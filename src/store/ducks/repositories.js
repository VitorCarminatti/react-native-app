...
export const Creators = {
  loadRepositoriesRequest: () => ({ type: Types.LOAD_REQUEST }),
  loadRepositoriesSuccess: data => ({ type: Types.LOAD_SUCCESS, payload: { data } }),
  loadRepositoriesFailure: () => ({ type: Types.LOAD_FAILURE }),
};
